    ...
    if (simsubscreennum == 3) {
      ...
      setTimeout(function () {
        ...
        document.getElementById("can3-12").innerHTML =
          "Theoretical discharge, Q<sub>th</sub> = ";
  ...
  if (simsubscreennum == 1) {
    if (flag == 1) {
      ...
      document.getElementById("pumptext").innerHTML =
        "Stop the pump by pressing the stop button.";
      ...
      document.getElementById("can1-1a").style.visibility = "visible";
      document.getElementById("can1off").onclick = function () {
        stepstop();
      };
    } else {
      document.getElementById("can1on").onclick = function () {
        step1();
      };
    }
    ...
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left: 70px; top: 190px; height: 50px; z-index: 10;";
    ...
    document.getElementById("can2-2").style.visibility = "hidden";
    document.getElementById("can2-3").style.visibility = "hidden";
    document.getElementById("can3-9").innerHTML =
      "Initial reading (water level till crest) = 3.15 cm";

    myInt = setInterval(function () {
      animatearrow();
    }, 500);
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left: 200px; top: 190px; height: 50px; z-index: 10;";
    ...
    document.getElementById("can3-7").onclick = function () {
      step3();
    };
    ...
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left: 315px; top: 390px; height: 50px; z-index: 10;";
    ...
    document.getElementById("can4-1a").style.visibility = "hidden";
    document.getElementById("can4-2").style.visibility = "hidden";
    document.getElementById("can4-3").style.visibility = "hidden";
    document.getElementById("can1-1a").style.visibility = "hidden";
    ...
    document.getElementById("can7-9").innerHTML =
      "Coefficient of discharge, C<sub>d</sub> = 0.63";
  }
}
...
function step2() {
  ...
  document.getElementById("arrow1").style =
    "visibility:visible ;position:absolute; left: 670px; top: 190px; height: 50px; z-index: 10;";
...
function step4() {
  ...
  document.getElementById("can4-1a").style.visibility = "visible";
  document.getElementById("can4-2").style.visibility = "hidden";
  ...
  setTimeout(function () {
    document.getElementById("can4-9").innerHTML =
      "Time required by water to fill 10cm height =" + values[p][5] + " sec";
    setTimeout(function () {
      document.getElementById("can4-10").innerHTML =
        "Discharge of water, Q<sub>act</sub> = ";
...
function step5() {
  document.getElementById("can6-3").innerHTML =
    "Theoretical discharge, Q<sub>th</sub> = " +
    values[p][3] +
    " cm<sup>3</sup>/sec";
  document.getElementById("can6-4").innerHTML =
    "Actual discharge, Q<sub>act</sub> = " +
    values[p][6] +
    " cm<sup>3</sup>/sec";
...
function refresh1() {
  ...
  document.getElementById("can3-12").innerHTML =
    "Theoretical discharge, Q<sub>act</sub> = ";
  document.getElementById("can4-9").innerHTML =
    "Time required by water to fill 10cm height =";
